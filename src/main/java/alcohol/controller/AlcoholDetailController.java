...
public class AlcoholDetailController {
	...
	public String reviewWrite(@RequestParam("num") String num, ReviewBean review, RedirectAttributes rttr,
		...
		if (member == null) {
			String msg = "�눥�븨紐� �쉶�썝�떂留� 湲��옉�꽦�씠 媛��뒫�빀�땲�떎. 濡쒓렇�씤 �썑 由щ럭瑜� �벑濡앺빐二쇱꽭�슂.";
		...
		if (checkByFlag <= 0) {
			String msg = "�빐�떦 �긽�뭹�쓣 援щℓ�븯�떊(援щℓ�솗�젙 �씠�썑) �쉶�썝�떂留� 湲��옉�꽦�씠 媛��뒫�빀�땲�떎.";
			String url = "/ex/detail.al?num=" + num;
		...
		if (checkReview >= 1) {
			String msg = "�씠誘� 由щ럭瑜� �옉�꽦�뻽�뒿�땲�떎.";
			String url = "/ex/detail.al?num=" + num;
	...
	public HashMap<String, String> heartUpdate(@RequestParam("id") String id, HttpServletRequest request) {
		...
		if (member != null) {
			...
			if (checkHeart <= 0) {
				...
				msg.put("message", "李쒖씠 �셿猷뚮릺�뿀�뒿�땲�떎.");
			} else {
				System.out.println("-------------- 李쒗븳 �긽�깭�씪 寃쎌슦 ------------");
				msg.put("message", "�씠誘� 李쒗븳 �긽�뭹�엯�땲�떎..");

			}
		} else {
			msg.put("message", "�옒紐삳맂 �젒洹쇱엯�땲�떎.");
